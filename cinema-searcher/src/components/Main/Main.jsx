        ...
        <div className={styles.container}>
            ...
            <div>
                <ul className={styles.pcNavMenu}>
                    <Link href={"/popular"}>
                        <li className={router.route == "/popular" ? styles.pageTitle : null}>
                            最近の人気
                        </li>
                    </Link>
                    <Link href={"/"}>
                        <li className={router.route == "/" ? styles.pageTitle : null}>
                            評価が高い映画
                        </li>
                    </Link>
                    <Link href={"/now_playing"}>
                        <li className={router.route == "/now_playing" ? styles.pageTitle : null}>
                            上映中
                        </li>
                    </Link>
                    <Link href={"/upcoming"}>
                        <li className={router.route == "/upcoming" ? styles.pageTitle : null}>
                            近日公開
                        </li>
                    </Link>
                </ul>
